...
public:
    ...
    void DrawAgros();                            // desenha a agro dos objetos na cena
    ...
    void AgroCollisionDetection();                  // trata a colisão entre objetos da cena
    bool AgroCollision(Object* oa, Object* ob);   // verifica se há colisão entre dois objetos
};
