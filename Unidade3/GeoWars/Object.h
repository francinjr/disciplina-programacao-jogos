...
public:
    ...
    // muda a agro do objeto
    virtual void Agro(Geometry* bb);

    // retorna a agro do objeto
    virtual Geometry* Agro() const;
    ...
    virtual void OnAgroCollision(Object* obj);
    // ------------------------------------------------
...
inline Geometry* Object::Agro() const
{
    return agro;
}
// -----------------------------------------------------------------------------
