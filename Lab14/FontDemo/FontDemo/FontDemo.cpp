...
void FontDemo::Init()
{
    ...
    verdana  = new Font("Resources/CascadiaCode20.png");
    verdana->Spacing("Resources/CascadiaCode.dat");
    verdana->Spacing(20);
}
...
void FontDemo::Draw()
{
    ...
    verdana->Draw(120, 300, "Cascadia Code 20", green, Layer::FRONT, 0.75, -30);
    //verdana->Draw(60, 375, "Verdana 12", green);

    verdana->Draw(60, 375, "Esta é a fonte Cascadia Code 20 pontos", black);
