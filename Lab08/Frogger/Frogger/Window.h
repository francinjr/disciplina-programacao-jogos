...
private:
    ...
    static float windowAspectRatio;         // aspect ratio da janela
    static int   screenWidth;               // largura da tela
    static int   screenHeight;              // altura da tela
    static long  monitorX;                  // posição x do monitor no desktop virtual
    static long  monitorY;                  // posição y do monitor no desktop virtual
    static uint  screenDpi;                 // dpi atual da tela
    static float windowScale;               // escala da janela para o dpi atual
